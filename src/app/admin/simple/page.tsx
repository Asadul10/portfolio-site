...
import { LogOut, Plus, Edit, Trash2, Eye, Save } from 'lucide-react';
...
export default function SimpleAdminDashboard() {
  ...
  const handleCreateProject = () => {
    ...
    setIsCreating(true);
    setIsEditing(true);
    console.log('Create project state set:', { isCreating: true, isEditing: true });
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <h1 className="text-xl font-semibold text-gray-900">Simple Admin Dashboard</h1>
              <Button
                variant="outline"
                size="sm"
                onClick={() => router.push('/')}
